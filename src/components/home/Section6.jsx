        ...
        <Column classes="mt-12 w-full">
          <WrappedBox classes="sm:grid-cols-2 w-full mx-auto gap-4">
            <Row
              ...
              onClick={() =>
                onHandleClickUrl("mailto:kibieptrid@gmail.com")
              }
            >
          ...
          <footer className="text-center py-4 w-full mt-11">
            <p className="text-sm text-white-700">© {currentYear} By Kibieptr . All Rights Reserved.</p>
          </footer>
        </Column>
      </ConstraintedBox>
    </ResponsiveBox>
